...
public interface PostTargetMapper {
    ...
    @Mapping(target = "socialChannelId", source = "socialChannel.id")
    ...
    @Mapping(target = "socialChannel", source = "socialChannel")
    ...
    PostTarget toEntity(SocialChannel socialChannel);
}
